...
# load all the data -----------------------------------------------------------
two_ages <- list.files('./results/random_age_validation/TD1_2_ages/',
                       full.names = TRUE, 
                       pattern = '*.rds')
four_ages <- list.files('./results/random_age_validation/TD1_4_ages/',
                        full.names = TRUE, 
                        pattern = '*.rds')
six_ages <- list.files('./results/random_age_validation/TD1_6_ages/',
                       full.names = TRUE, 
                       pattern = '*.rds')
eight_ages <- list.files('./results/random_age_validation/TD1_8_ages/',
                         full.names = TRUE, 
                         pattern = '*.rds')
